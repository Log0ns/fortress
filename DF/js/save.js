...
function saveGame() {
  ...
  const state = {
    ...
    dwarves:    dwarves.map(d => ({ name:d.name, job:d.job, c:d.c, r:d.r, z:d.z, wx:d.wx, wy:d.wy, dead:d.dead })),
    ...
    digStairJobs: [...digStairJobs.values()].map(({z,r,c})=>({z,r,c})),
    ...
    stairs:     [...stairs.values()].map(({z,r,c})=>({z,r,c})),
...
function loadGame() {
  ...
  if (s.cachedChunks) {
    for (const entry of s.cachedChunks) {
      ...
      const t = new Map();
      (entry.trees||[]).forEach(o => t.set(tileKey(o.z,o.r,o.c), {...o}));
  ...
  dwarves.forEach((d, i) => {
    ...
    d.name=sd.name; d.job=sd.job; d.health=sd.health; d.hunger=sd.hunger||0;
    ...
    d.carrying=null; d.buildJob=null; d.buildMat=null; d.buildDest=null; d._buildToDest=null; d.farmPlot=null;
  });

  food.clear();       s.food.forEach(o       => food.set(tileKey(o.z,o.r,o.c), {...o, claimedBy:null}));
  resources.clear();  s.resources.forEach(o  => resources.set(tileKey(o.z,o.r,o.c), {...o, claimedBy:null}));
  stockpiles.clear(); s.stockpiles.forEach(o => stockpiles.set(tileKey(o.z,o.r,o.c), {...o}));
  digJobs.clear();    s.digJobs.forEach(o    => digJobs.set(tileKey(o.z,o.r,o.c), {...o, claimedBy:null}));
  digStairJobs.clear(); (s.digStairJobs||[]).forEach(o => digStairJobs.set(tileKey(o.z,o.r,o.c), {...o, claimedBy:null}));
  chopJobs.clear();    (s.chopJobs||[]).forEach(o    => chopJobs.set(tileKey(o.z,o.r,o.c), {...o, claimedBy:null}));
  destroyJobs.clear(); (s.destroyJobs||[]).forEach(o => destroyJobs.set(tileKey(o.z,o.r,o.c), {...o, claimedBy:null}));
  trees.clear();      (s.trees||[]).forEach(o    => trees.set(tileKey(o.z,o.r,o.c), {...o}));
  buildJobs.clear();  s.buildJobs.forEach(o  => buildJobs.set(tileKey(o.z,o.r,o.c), {...o, claimedBy:null}));
  workshops.clear();  s.workshops.forEach(o  => workshops.set(tileKey(o.z,o.r,o.c), {...o, claimedBy:null}));
  stairs.clear();     s.stairs.forEach(o     => stairs.set(tileKey(o.z,o.r,o.c), {z:o.z,r:o.r,c:o.c}));
  beds.clear();       (s.beds||[]).forEach(o  => beds.set(tileKey(o.z,o.r,o.c), {...o, claimedBy:null}));
  doors.clear();      (s.doors||[]).forEach(o => doors.set(tileKey(o.z,o.r,o.c), {...o}));
  furniture.clear();  (s.furniture||[]).forEach(o => furniture.set(tileKey(o.z,o.r,o.c), {...o}));
  farmPlots.clear();  s.farmPlots.forEach(o  => farmPlots.set(tileKey(o.z,o.r,o.c), {...o, claimedBy:null}));

  revealed.clear();
  if (s.revealed) s.revealed.forEach(k => revealed.add(k));
...
// Clear stale save on load
localStorage.removeItem('df_save');
